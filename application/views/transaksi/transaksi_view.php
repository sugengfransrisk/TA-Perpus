                ...
                <?php if($total == 0): ?>
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                                 <a href="<?php echo base_url()?>transaksi/cetakpinjam"  class="btn btn-primary btn-lg fa fa-print">Cetak</a>
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <a href="<?php echo base_url()?>transaksi/cetakkembali"  class="btn btn-success btn-lg fa fa-print">Cetak</a>
